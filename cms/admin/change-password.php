...
{
$_SESSION['msg']="Old Password don't match !!";
}
}
?>
<!DOCTYPE html>
...
<?php include('include/header.php');?>
	...
	<div style="background-color: #eeba30;" class="wrapper">
		<div class="container">
			<div class="row">
...
<input type="password" placeholder="Enter your new Password again"  name="confirmpassword" class="span8 tip" required>
										...
										<div class="control-group">
											<div class="controls">
												<button style="background-color: #3A98E9; color: white;" type="submit" name="submit" class="btn">Submit</button>
											</div>
										</div>
									</form>
							</div>
