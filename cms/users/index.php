...
$status=1;
$log=mysqli_query($con,"insert into userlog(uid,email,userip,status) values('".$_SESSION['id']."','".$_SESSION['login']."','$uip','$status')");
...
$uip=$_SERVER['REMOTE_ADDR'];
$status=0;
mysqli_query($con,"insert into userlog(email,userip,status) values('".$_SESSION['login']."','$uip','$status')");
...
return true;
  ...
  <body>
	  ...
	  <div style="margin-top: 50px;" id="login-page">
	  	<div class="container">
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="email" class="form-control" name="email" placeholder="IUT mail id"  required autofocus>
		            <br>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
    ...
    <script>
        $.backstretch("assets/img/iut3.png", {speed: 500});
    </script>
