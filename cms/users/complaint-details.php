...
<html lang="en">
  <head>
    ...
    <title>FDCMS | Complaint Details</title>
...
<label class="col-sm-2 col-sm-2 control-label"><b>Hall :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['hall']);?></p>
              </div>
            </div>  
...
<?php } ?> -->
            ...
            <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Room :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['room']);?></p>
              </div>
 ...
 <!-- <div class="row mt"> -->
            ...
            <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Preferable Date and Time :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['pdt']);?></p>
              </div> 
              <br><br>
